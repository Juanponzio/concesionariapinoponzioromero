...
# ================= Pagina de empleados =================
    def agregar_auto():
        ...
        if not all([Nombre, Apellido, Fecha_nac, DNI, Telefono, Email,Horario,Fecha_ingreso,Puesto]):
            messagebox.showerror("Error", "Completa todos los campos")
            return

        tabla.insert("", "end", values=(Nombre, Apellido, Fecha_nac, DNI, Telefono, Email,Horario,Fecha_ingreso,Puesto))
        limpiar_campos()
        messagebox.showinfo("Éxito", "Auto agregado al stock")
